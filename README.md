...
```bash
pip install -e .[ocr]
clearscan examples/generated/sample_document.jpg --out outputs --mode binary --ocr --ocr-engine auto --ocr-lang jpn+eng --layout --searchable-pdf --expected-text answer.txt
```
...
src/clearscan_cv/
  ...
  export.py       画像 PDF と searchable PDF の生成
  static/
