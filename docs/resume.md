...
- Added browser-side Tesseract.js OCR over the enhanced scan output with copy, TXT export, and hidden-text searchable PDF generation, structured as the second stage before document layout recovery.
