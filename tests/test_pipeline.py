...
class PipelineTest(unittest.TestCase):
    ...
    def test_static_app_generates_pdf_on_device(self) -> None:
        ...
        self.assertIn("outputHeight", html)
        self.assertIn("dewarpOffsetRatio", html)
        self.assertIn("曲面確認", html)
        self.assertIn("曲面強め", html)
        ...
        self.assertIn("evaluateOcrTextlineGeometry", html)
        self.assertIn("ocrWordCenterAngle", html)
        self.assertIn("文字行傾き確認", html)
        self.assertIn("state.ocrGeometry", html)
    ...
    def test_static_app_has_pwa_worker(self) -> None:
        ...
        self.assertIn("pocketcv-pdf-v26", worker)
