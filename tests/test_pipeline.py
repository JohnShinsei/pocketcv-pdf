...
class PipelineTest(unittest.TestCase):
    ...
    def test_static_app_generates_pdf_on_device(self) -> None:
        ...
        self.assertIn('const deskewed = deskewCanvasByTextLines(corrected.canvas, corrected.detection);', html)
        ...
        self.assertIn("strokeContrast > 34", html)
    ...
    def test_static_app_has_pwa_worker(self) -> None:
        ...
        self.assertIn("pocketcv-pdf-v14", worker)
